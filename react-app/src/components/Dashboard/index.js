...
function Dashboard() {
  return (
    <>
      <div className="sm:h-115 md:h-70 lg:hidden"></div>
      <div className="w-full h-1/2-screen flex flex-row sm:flex-col-reverse md:flex-col-reverse lg:flex-row">
        <div className="bg-blue-500 w-1/3 sm:w-full py-10 md:w-full lg:w-1/3 lg:gap-0 text-white flex flex-col justify-center items-center">
          ...
          <div className="px-5 sm:px-25 text-5xl sm:text-3xl md:text-3xl lg:text-4xl font-bold flex justify-center"></div>
          <div className="px-5 sm:px-25 text-5xl sm:text-3xl md:text-4xl lg:text-4xl font-bold flex text-center">
            County & Surrounding Areas
          </div>
          <div className="px-5 sm:px-20 text-5xl sm:text-3xl md:text-3xl lg:text-4xl mt-2 font-bold flex justify-center"></div>
          <div className="text-2xl sm:text-lg md:text-3xl lg:text-3xl font-light mt-5">
            For Installation and Repair
          </div>
          <div className="text-base sm:text-xl md:text-2xl md:font-light lg:text-3xl mt-2">
            Call Us Today!
          </div>
          <div className="text-lg sm:text-3xl md:text-3xl  font-extrabold">
            (301) 820 - 5182
          </div>
          <RequestAppointmentButton classes="mt-5 text-black sm:mb-5 sm:px-4 lg:px-2 lg:mx-4" />
        </div>
        <div className="w-2/3 sm:w-full md:w-full lg:mt-0">
          {/* a wide ac picture */}
          <img
      ...
      <div className="my-20 w-full grid grid-cols-3 gap-20 px-20 sm:px-10 sm:gap-5 sm:mt-5 sm:flex sm:flex-col md:mt-10 md:gap-10 lg:gap-20 lg:mt-20">
