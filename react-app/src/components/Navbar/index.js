...
function Navbar({ isLoaded }) {
  ...
  return (
    <div className="w-full h-40 grid grid-cols-2 items-center md:px-5 lg:px-20">
      <div className="">
      ...
      <div className="flex flex-row justify-end items-center space-x-4 p-4 ">
        <div className="flex flex-col text-center lg:block">
          <div className="font-thin text-xl sm:font-normal md:font-normal md:text-2xl lg:text-xl lg:font-thin">Call Today!</div>
